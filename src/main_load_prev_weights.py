...
*feedforward NNLM
*detailed error analysis (print text with mistakes)
...
CONF = {
    ...
    "TRAIN_DATA": "../data/train_pause",#"../../Punctuator2/data/train",
    "DEV_DATA": "../data/dev_pause",#"../../Punctuator2/data/dev",
    "USE_PAUSES": False
}
...
def process_corpus(net, dataset, mode='train', learning_rate=None):
    ...
    if CONF["USE_PAUSES"]:
        pass#dataset["pauses"] = np.tanh(duration_normalizer(dataset["pauses"])) #Paistab, et ilma normaliseerimiseta töötab paremini!
...
if __name__ == "__main__":
    ...
    net = utils.load_model("../out/model_lstm_FINAL_0.005") # TEMPORARY
    net.bptt_steps = CONF["BPTT_STEPS"]
